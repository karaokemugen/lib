...
export function formatKaraV4(kara: Kara): KaraFileV4 {
	...
	return {
		...
		data: {
			...
			tags: {
				authors: kara.authors && kara.authors.length > 0 ? kara.authors : undefined,
				creators: kara.creators && kara.creators.length > 0 ? kara.creators : undefined,
				families: kara.families && kara.families.length > 0 ? kara.families : undefined,
				genres: kara.genres && kara.genres.length > 0 ? kara.genres : undefined,
				groups: kara.groups && kara.groups.length > 0 ? kara.groups : undefined,
				langs: kara.langs && kara.langs.length > 0 ? kara.langs : undefined,
				misc: kara.misc && kara.misc.length > 0 ? kara.misc : undefined,
				origins: kara.origins && kara.origins.length > 0 ? kara.origins : undefined,
				platforms: kara.platforms && kara.platforms.length > 0 ? kara.platforms : undefined,
				singers: kara.singers && kara.singers.length > 0 ? kara.singers : undefined,
				songtypes: kara.songtypes && kara.songtypes.length > 0 ? kara.songtypes : undefined,
				songwriters: kara.songwriters && kara.songwriters.length > 0 ? kara.songwriters : undefined
			},
			title: kara.title,
			year: kara.year
		}

...
export function ASSContentCleanup(assText: string, setProperties?: { title: string, author: string }, overwrite = false) {
	...
	if (scriptInfoSection) {
		...
		// Reset PlayRes
		/**
		 * This is disabled for now as it can mess up with some songs that purposedly kept the playresx/y or until we can safely calculate how to modify font sizes if we enable it again.
